  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        health: "bg-gradient-primary text-white hover:shadow-elevated transform hover:scale-105 shadow-glossy font-medium",
        "health-secondary": "bg-gradient-secondary text-white hover:shadow-elevated transform hover:scale-105 shadow-glossy font-medium",
        "health-outline": "border-2 border-primary bg-background text-primary hover:bg-primary hover:text-white shadow-card",
        glossy: "bg-gradient-glossy border border-border/50 text-foreground hover:shadow-elevated shadow-card backdrop-blur-sm",
      },
      size: {
